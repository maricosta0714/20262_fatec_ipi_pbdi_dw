...
-- GROUP BY 
-- d.year, d.month, d.month_name, b.branch_code, b.city
...
--     invoice_nk, date_sk, branch_sk, product_sk, customer_sk, payment_sk,
--     unit_price, quantity, total, tax, cogs, gross_income, rating
-- )
-- SELECT 
--     s.invoice_id,
--     CAST(TO_CHAR(s.sale_ts, 'YYYYMMDD') AS INTEGER),
--     db.branch_sk, dp.product_sk, dc.customer_sk, dpa.payment_sk,
--     s.unit_price, s.quantity, s.total, s.tax_5pct, s.cogs, s.gross_income, s.rating
